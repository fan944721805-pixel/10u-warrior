...
"选择策略":"Choose strategy",
    ...
    "裸K版赌狗：吞没、长影线、两连阳阴或大实体K线，抓到明确形态就敢上；多空明显打架才停手。":"The raw-candle Gambler: act on a clear engulfing bar, rejection wick, two-candle run, range break or forceful candle body without waiting for several patterns. Stand down when bullish and bearish evidence strongly conflict.",
    '实时进场':'Signal-based entry',
  ...
  function english(text){
    ...
    return text
      ...
      .replace(/^模拟决策 · (赌狗|超级AI|守财奴)$/, (_,strategy)=>`Paper decision · ${messages[strategy]||strategy}`)
